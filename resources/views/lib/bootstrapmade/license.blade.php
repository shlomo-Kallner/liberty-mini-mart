<!-- BEGIN Bootstrapmade Flexor License -->
<!-- 
...
-->
<!-- Flexor License Details Copied from https://bootstrapmade.com/license/  -->
<!-- on May 14th 2018. -->
...
<!-- 
    ...
    You can obtain a license and remove the back links to BootstrapMade from the template you are using. Here are our current pricing options:
        ...
        Single theme for use in single website or application: € 9
        Single theme for use in multiple websites or applications: € 29
        Membership plan with access to all of our themes for use in unlimited websites, starting at: € 49 
        
    Order Now at https://bootstrapmade.com/buy/.
-->

<!-- END Bootstrapmade Flexor License -->