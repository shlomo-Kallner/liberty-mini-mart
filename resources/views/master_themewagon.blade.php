                ...
                <div class="carousel-inner" role="listbox">
                    ...
                    <div class="item carousel-item-five">
                        <div class="container">
                            ...
                            <img class="carousel-position-five animate-delay hidden-sm hidden-xs" src="{{ asset('lib/themewagon/metronicShopUI/theme/assets/pages/img/shop-slider/slide2/price.png') }}" alt="Price" data-animation="animated zoomIn">
                        </div>
                    </div>
                            ...
                            <div id="myCarousel" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    <div class="item active">
                                        <img src="{{ asset('lib/themewagon/metronicShopUI/theme/assets/pages/img/index-sliders/slide1.jpg') }}" class="img-responsive" alt="Berry Lace Dress">
                                    </div>
                                    <div class="item">
                                        <img src="{{ asset('lib/themewagon/metronicShopUI/theme/assets/pages/img/index-sliders/slide2.jpg') }}" class="img-responsive" alt="Berry Lace Dress">
                                    </div>
                                    <div class="item">
                                        <img src="{{ asset('lib/themewagon/metronicShopUI/theme/assets/pages/img/index-sliders/slide3.jpg') }}" class="img-responsive" alt="Berry Lace Dress">
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="brands">
            <div class="container">
                <div class="owl-carousel owl-carousel6-brands">
                    <a href="{{ url('lib/themewagon/metronicShopUI/theme/shop-product-list.html') }}">
                        <img src="{{ asset('lib/themewagon/metronicShopUI/theme/assets/pages/img/brands/canon.jpg') }}" alt="canon" title="canon">
                    </a>
                    <a href="{{ url('lib/themewagon/metronicShopUI/theme/shop-product-list.html') }}">
                        <img src="{{ asset('lib/themewagon/metronicShopUI/theme/assets/pages/img/brands/esprit.jpg') }}" alt="esprit" title="esprit">
                    </a>
                    <a href="{{ url('lib/themewagon/metronicShopUI/theme/shop-product-list.html') }}">
                        <img src="{{ asset('lib/themewagon/metronicShopUI/theme/assets/pages/img/brands/gap.jpg') }}" alt="gap" title="gap">
                    </a>
                    <a href="{{ url('lib/themewagon/metronicShopUI/theme/shop-product-list.html') }}">
                        <img src="{{ asset('lib/themewagon/metronicShopUI/theme/assets/pages/img/brands/next.jpg') }}" alt="next" title="next">
                    </a>
                    <a href="{{ url('lib/themewagon/metronicShopUI/theme/shop-product-list.html') }}">
                        <img src="{{ asset('lib/themewagon/metronicShopUI/theme/assets/pages/img/brands/puma.jpg') }}" alt="puma" title="puma">
                    </a>
                    <a href="{{ url('lib/themewagon/metronicShopUI/theme/shop-product-list.html') }}">
                        <img src="{{ asset('lib/themewagon/metronicShopUI/theme/assets/pages/img/brands/zara.jpg') }}" alt="zara" title="zara">
                    </a>
                    <a href="{{ url('lib/themewagon/metronicShopUI/theme/shop-product-list.html') }}">
                        <img src="{{ asset('lib/themewagon/metronicShopUI/theme/assets/pages/img/brands/canon.jpg') }}" alt="canon" title="canon">
                    </a>
