<template>
  <div :class="!myUtils.isEmpty(extraOuterCss) ? extraOuterCss : ''">
                        ...
                        <div v-if="!myUtils.isEmpty(price)" class="price">
                          <strong>
                            <span v-if="myUtils.isFiniteOrConvertable(price)">
                              <i :class="['fa', { 'curency' : currency } ]"></i>
                            </span>{{ price }}
                          </strong>
                          <em v-if="!myUtils.isEmpty(sale)">
                            <i v-if="myUtils.isFiniteOrConvertable(sale)" :class="['fa', { 'curency' : currency } ]"></i>
                            <span>{{ sale }}</span>
                          </em>
                        </div>
